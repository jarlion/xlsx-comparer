 ...
 * @returns 
 */
export function readXlsx<R extends Record<string, string>>(path: string, sheetIndex: number = 0, opts: Sheet2JSONOpts | undefined = { header: 'A', defval: '' }, fix: boolean = true): R[] {
